...
async function createComponentTreeInternal({ loaderTree: tree, parentParams, rootLayoutIncluded, injectedCSS, injectedJS, injectedFontPreloadTags, getViewportReady, getMetadataReady, ctx, missingSlots, preloadCallbacks, authInterrupts, StreamingMetadataOutlet }) {
   ...
   */ let MaybeComponent = LayoutOrPage;
    ...
    if (isPage) {
        const PageComponent = isSegmentViewEnabled ? (pageProps)=>{
            return /*#__PURE__*/ (0, _jsxruntime.jsx)(SegmentViewNode, {
                type: nodeName,
        ...
        const SegmentComponent = isSegmentViewEnabled ? (segmentProps)=>{
            return /*#__PURE__*/ (0, _jsxruntime.jsx)(SegmentViewNode, {
                type: nodeName,
                pagePath: normalizePageOrLayoutFilePath(dir, layoutOrPagePath),
                children: /*#__PURE__*/ (0, _jsxruntime.jsx)(Component, {
...
function normalizePageOrLayoutFilePath(projectDir, layoutOrPagePath) {
    const dir = projectDir /*ctx.renderOpts.dir*/  || process.cwd();
    const relativePath = (layoutOrPagePath || '')// remove turbopack [project] prefix
    .replace(/^\[project\][\\/]/, '')// remove the project root from the path
    .replace(dir, '')// remove /(src/)?app/ dir prefix
    .replace(/^[\\/](src[\\/])?app[\\/]/, '');
    return relativePath;
}
