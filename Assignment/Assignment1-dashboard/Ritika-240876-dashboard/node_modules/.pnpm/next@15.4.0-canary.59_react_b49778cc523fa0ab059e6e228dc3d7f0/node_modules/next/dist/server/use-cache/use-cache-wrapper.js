...
async function generateCacheEntryImpl(workStore, outerWorkUnitStore, innerCacheStore, clientReferenceManifest, encodedArguments, fn, timeoutError) {
    ...
    if ((outerWorkUnitStore == null ? void 0 : outerWorkUnitStore.type) === 'prerender') {
        ...
        const { prelude } = await (0, _staticedge.unstable_prerender)(resultPromise, clientReferenceManifest.clientModules, {
        ...
        stream = (0, _serveredge.renderToReadableStream)(resultPromise, clientReferenceManifest.clientModules, {
            environmentName: 'Cache',
            temporaryReferences,
            onError: handleError
        });
...
function cache(kind, id, boundArgsLength, originalFn) {
    ...
    const cachedFn = {
        [name]: async function(...args) {
            ...
            const encodeCacheKeyParts = ()=>(0, _clientedge.encodeReply)(cacheKeyParts, {
                    temporaryReferences,
