...
const _segmentexplorer = require("../../overview/segment-explorer");
...
function DevToolsIndicator(param) {
    let { state, errorCount, isBuildError, ...props } = param;
...
function DevToolsPopover(param) {
    let { routerType, disabled, issueCount, isStaticRoute, isTurbopack, isBuildError, hide, dispatch, scale, setScale } = param;
    ...
    function openErrorOverlay() {
        ...
        if (issueCount > 0) {
            dispatch({
                type: _shared.ACTION_ERROR_OVERLAY_OPEN
            });
        }
    }
    function toggleErrorOverlay() {
        dispatch({
            type: _shared.ACTION_ERROR_OVERLAY_TOGGLE
        });
    }
    ...
    return /*#__PURE__*/ (0, _jsxruntime.jsxs)(_toast.Toast, {
        ...
        children: [
            ...
            process.env.__NEXT_DEVTOOL_SEGMENT_EXPLORER ? /*#__PURE__*/ (0, _jsxruntime.jsx)(_segmentexplorer.SegmentsExplorer, {
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, _jsxruntime.jsxs)("div", {
                            ...
                            children: [
                                ...
                                process.env.__NEXT_DEVTOOL_SEGMENT_EXPLORER ? /*#__PURE__*/ (0, _jsxruntime.jsx)(MenuItem, {
                                    "data-rendered-files": true,
