 ...
 */ function getSourcemappedFrameIfPossible(frame, sourceMapCache, inspectOptions) {
    ...
    const codeFrame = (0, _shared.getOriginalCodeFrame)(originalFrame, sourceContent, inspectOptions.colors);
    return {
        stack: originalFrame,
        code: codeFrame
    };
...
function parseAndSourceMap(error, inspectOptions) {
    ...
    for (const frame of unsourcemappedStack){
        if (frame.file === null) {
            ...
            if (sourcemappedFrame.code !== null && sourceFrame === null && // TODO: Is this the right choice?
