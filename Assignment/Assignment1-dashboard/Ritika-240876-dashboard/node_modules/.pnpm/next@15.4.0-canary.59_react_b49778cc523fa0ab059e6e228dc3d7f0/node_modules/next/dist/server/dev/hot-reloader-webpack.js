...
const _restartdevservermiddleware = require("../../client/components/react-dev-overlay/server/restart-dev-server-middleware");
...
class HotReloaderWebpack {
    ...
    async start() {
        ...
        this.middlewares = [
            ...
            (0, _restartdevservermiddleware.getRestartDevServerMiddleware)(this.telemetry)
        ];
    }
