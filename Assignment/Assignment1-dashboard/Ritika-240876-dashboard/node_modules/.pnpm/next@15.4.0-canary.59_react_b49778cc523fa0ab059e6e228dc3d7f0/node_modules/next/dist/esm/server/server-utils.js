...
function filterInternalQuery(query, paramKeys, defaultRouteRegex) {
...
export function normalizeCdnUrl(req, paramKeys, defaultRouteRegex) {
...
export function getServerUtils({ page, i18n, basePath, rewrites, pageIsDynamic, trailingSlash, caseSensitive }) {
     ...
     */ normalizeDynamicRouteParams: (query, ignoreMissingOptional)=>{
        ...
        normalizeCdnUrl: (req, paramKeys)=>normalizeCdnUrl(req, paramKeys, defaultRouteRegex),
        interpolateDynamicPath: (pathname, params)=>interpolateDynamicPath(pathname, params, defaultRouteRegex),
        filterInternalQuery: (query, paramKeys)=>filterInternalQuery(query, paramKeys, defaultRouteRegex)
    };
}
