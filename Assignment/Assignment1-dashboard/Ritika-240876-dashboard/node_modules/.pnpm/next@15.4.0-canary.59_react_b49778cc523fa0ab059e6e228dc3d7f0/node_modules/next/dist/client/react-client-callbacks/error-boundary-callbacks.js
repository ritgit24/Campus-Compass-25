...
const _globalerror = /*#__PURE__*/ _interop_require_default._(require("../components/global-error"));
function onCaughtError(thrownValue, errorInfo) {
    ...
    if (process.env.NODE_ENV !== 'production') {
        ...
        if (errorInfo.componentStack) {
            (0, _stitchederror.setComponentStack)(error, errorInfo.componentStack);
        }
        // Log and report the error with location but without modifying the error stack
        (0, _interceptconsoleerror.originConsoleError)('%o\n\n%s', thrownValue, errorLocation);
        (0, _useerrorhandler.handleClientError)(error);
    } else {
        (0, _interceptconsoleerror.originConsoleError)(thrownValue);
    }
}
