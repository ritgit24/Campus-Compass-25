...
import { CONFIG_FILES, PHASE_DEVELOPMENT_SERVER, PHASE_PRODUCTION_BUILD, PHASE_PRODUCTION_SERVER } from '../shared/lib/constants';
...
function assignDefaults(dir, userConfig, silent) {
    var _defaultConfig_experimental, _result_experimental, _result_experimental1, _result_experimental_serverActions, _result_experimental2, _result_turbopack, _result_turbopack1, _result_turbopack2, _result_devIndicators, _result_experimental3, _result_experimental4;
    ...
    if (isStableBuild()) {
        var _result_experimental5, _result_experimental6, _result_experimental7, _result_experimental8;
        ...
        } else if ((_result_experimental6 = result.experimental) == null ? void 0 : _result_experimental6.dynamicIO) {
            throw Object.defineProperty(new CanaryOnlyError({
        ...
        } else if ((_result_experimental8 = result.experimental) == null ? void 0 : _result_experimental8.nodeMiddleware) {
            throw Object.defineProperty(new CanaryOnlyError({
    ...
    if (hasWarnedBuildActivityPosition && result.devIndicators !== false && 'buildActivityPosition' in result.devIndicators && result.devIndicators.buildActivityPosition !== result.devIndicators.position) {
    ...
    if (result.experimental.dynamicIO) {
        var _userConfig_experimental, _userConfig_experimental1;
        if (((_userConfig_experimental = userConfig.experimental) == null ? void 0 : _userConfig_experimental.ppr) === false || ((_userConfig_experimental1 = userConfig.experimental) == null ? void 0 : _userConfig_experimental1.ppr) === 'incremental') {
            var _userConfig_experimental2;
            throw Object.defineProperty(new Error(`\`experimental.ppr\` can not be \`${JSON.stringify((_userConfig_experimental2 = userConfig.experimental) == null ? void 0 : _userConfig_experimental2.ppr)}\` when \`experimental.dynamicIO\` is \`true\`. PPR is implicitly enabled when Dynamic IO is enabled.`), "__NEXT_ERROR_CODE", {
                value: "E686",
                enumerable: false,
                configurable: true
            });
...
export default async function loadConfig(phase, dir, { customConfig, rawConfig, silent = true, onLoadUserConfig, reactProductionProfiling } = {}) {
    ...
    if (customConfig) {
        return await applyModifyConfig(assignDefaults(dir, {
            configOrigin: 'server',
            configFileName,
            ...customConfig
        }, silent), phase, silent);
