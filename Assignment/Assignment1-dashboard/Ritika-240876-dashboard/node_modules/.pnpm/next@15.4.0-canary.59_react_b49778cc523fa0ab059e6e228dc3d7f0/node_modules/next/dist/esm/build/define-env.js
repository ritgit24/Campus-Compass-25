...
export function getDefineEnv({ isTurbopack, clientRouterFilters, config, dev, distDir, projectPath, fetchCacheKeyPrefix, hasRewrites, isClient, isEdgeServer, isNodeServer, middlewareMatchers, omitNonDeterministic }) {
    ...
    const defineEnv = {
        ...
        'process.env.__NEXT_DEVTOOL_SEGMENT_EXPLORER': config.experimental.devtoolSegmentExplorer ?? false
    };
