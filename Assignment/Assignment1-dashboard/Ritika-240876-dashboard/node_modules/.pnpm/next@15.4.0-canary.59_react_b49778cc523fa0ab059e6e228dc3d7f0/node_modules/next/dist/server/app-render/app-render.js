 ...
 */ async function spawnDynamicValidationInDev(resolveValidation, tree, ctx, isNotFound, clientReferenceManifest, requestStore) {
    ...
    try {
                ...
                onError: (err, errorInfo)=>{
                    if ((0, _dynamicrendering.isPrerenderInterruptedError)(err) || finalClientController.signal.aborted) {
                        ...
                        if (typeof componentStack === 'string') {
                            (0, _dynamicrendering.trackAllowedDynamicAccess)(workStore.route, componentStack, dynamicValidation);
                        }
                        return;
                    }
                    return (0, _createerrorhandler.getDigestForWellKnownError)(err);
        ...
        resolveValidation(/*#__PURE__*/ (0, _jsxruntime.jsx)(LogSafely, {
            fn: _dynamicrendering.throwIfDisallowedDynamic.bind(null, workStore, preludeIsEmpty, dynamicValidation, serverDynamicTracking, clientDynamicTracking)
        }));
    } catch (thrownValue) {
        // Even if the root errors we still want to report any dynamic IO errors
        // that were discovered before the root errored.
        const preludeIsEmpty = true;
        let loggingFunction = _dynamicrendering.throwIfDisallowedDynamic.bind(null, workStore, preludeIsEmpty, dynamicValidation, serverDynamicTracking, clientDynamicTracking);
...
async function prerenderToStream(req, res, ctx, metadata, tree) {
    ...
    try {
       ...
       */ // Prerender controller represents the lifetime of the prerender.
            ...
            // detected invalid dynamic usage in the initial prerender phase.
            if (workStore.invalidDynamicUsageError) {
                if ((0, _usecacheerrors.isUseCacheTimeoutError)(workStore.invalidDynamicUsageError) && allowEmptyStaticShell) {
                    ...
                    return {
                        ...
                        collectedRevalidate: _constants1.INFINITE_CACHE,
                        collectedExpire: _constants1.INFINITE_CACHE,
                        collectedStale: selectStaleTime(_constants1.INFINITE_CACHE),
                        collectedTags: null
                    };
                }
            ...
            if (!allowEmptyStaticShell) {
                (0, _dynamicrendering.throwIfDisallowedDynamic)(workStore, preludeIsEmpty, dynamicValidation, serverDynamicTracking, clientDynamicTracking);
            }
            const getServerInsertedHTML = (0, _makegetserverinsertedhtml.makeGetServerInsertedHTML)({
                polyfills,
                renderServerInsertedHTML,
