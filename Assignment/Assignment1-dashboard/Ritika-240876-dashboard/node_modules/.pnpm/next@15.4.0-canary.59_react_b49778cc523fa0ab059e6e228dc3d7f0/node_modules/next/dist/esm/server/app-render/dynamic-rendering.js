...
export function trackAllowedDynamicAccess(route, componentStack, dynamicValidation) {
...
export function throwIfDisallowedDynamic(workStore, hasEmptyShell, dynamicValidation, serverDynamic, clientDynamic) {
