   ...
   */ async prepare() {
     ...
     */ const couldSupportPPR = this.isAppPPREnabled && typeof routeModule !== 'undefined' && (0, _checks.isAppPageRouteModule)(routeModule);
                ...
                if ((0, _checks.isAppRouteRouteModule)(routeModule)) {
                    ...
                    if ((0, _checks.isPagesRouteModule)(routeModule)) {
                        ...
                        if (components.ComponentMod.handler && process.env.NEXT_RUNTIME !== 'edge') {
                            ...
                            request.url = req.url = `${parsedInitUrl.pathname}${parsedInitUrl.search || ''}`;
                            // propagate the request context for dev
                            (0, _requestmeta.setRequestMeta)(request, (0, _requestmeta.getRequestMeta)(req));
                            (0, _requestmeta.addRequestMeta)(request, 'projectDir', this.dir);
                            (0, _requestmeta.addRequestMeta)(request, 'isIsrFallback', pagesFallback);
                            ...
                            if (renderOpts.err) {
                                (0, _requestmeta.addRequestMeta)(request, 'invokeError', renderOpts.err);
                            }
                            ...
                            if (!result) {
                                throw Object.defineProperty(new Error(`Invariant: missing result from invoking ${pathname} handler`), "__NEXT_ERROR_CODE", {
                                    value: "E681",
                                    enumerable: false,
                                    configurable: true
                                });
        ...
        let responseGenerator = async ({ hasResolved, previousCacheEntry, isRevalidating })=>{
            ...
            const fallbackRouteParams = isDynamic && isRoutePPREnabled && ((0, _requestmeta.getRequestMeta)(req, 'renderFallbackShell') || isDebugFallbackShell) ? (0, _fallbackparams.getFallbackRouteParams)(pathname) : null;
            // Perform the render.
            return doRender({
                postponed,
                pagesFallback: undefined,
        ...
        const didPostpone = ((_cacheEntry_value = cacheEntry.value) == null ? void 0 : _cacheEntry_value.kind) === _responsecache.CachedRouteKind.APP_PAGE && typeof cacheEntry.value.postponed === 'string';
        ...
        if (onCacheEntry) {
            ...
            const finished = await onCacheEntry({
                ...
                value: {
                    ...cacheEntry.value,
                    kind: ((_cacheEntry_value1 = cacheEntry.value) == null ? void 0 : _cacheEntry_value1.kind) === _responsecache.CachedRouteKind.APP_PAGE ? 'PAGE' : (_cacheEntry_value2 = cacheEntry.value) == null ? void 0 : _cacheEntry_value2.kind
                }
            }, {
