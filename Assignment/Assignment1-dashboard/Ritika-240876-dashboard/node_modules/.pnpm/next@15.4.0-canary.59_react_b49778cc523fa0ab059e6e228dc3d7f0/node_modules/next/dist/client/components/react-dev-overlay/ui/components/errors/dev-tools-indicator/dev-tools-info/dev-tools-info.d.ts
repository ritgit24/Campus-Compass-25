...
export declare function DevToolsInfo({ title, children, learnMoreLink, isOpen, triggerRef, closeButton, close, ...props }: DevToolsInfoProps): import("react/jsx-runtime").JSX.Element | null;
