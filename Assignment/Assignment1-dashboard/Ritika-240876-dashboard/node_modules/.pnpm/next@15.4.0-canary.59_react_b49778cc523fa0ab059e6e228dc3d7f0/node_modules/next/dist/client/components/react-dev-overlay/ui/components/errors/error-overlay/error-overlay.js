...
function ErrorOverlay(param) {
    let { state, dispatch, runtimeErrors, errorCount } = param;
    const isTurbopack = !!process.env.TURBOPACK;
    // This hook lets us do an exit animation before unmounting the component
    const { mounted, rendered } = (0, _usedelayedrender.useDelayedRender)(state.isErrorOverlayOpen, {
    ...
    return /*#__PURE__*/ (0, _jsxruntime.jsx)(_errors.Errors, {
        ...
        onClose: ()=>{
            dispatch({
                type: _shared.ACTION_ERROR_OVERLAY_CLOSE
            });
        }
    });
}
