...
function HotReload(param) {
    ...
    const dispatcher = (0, _react.useMemo)(()=>{
        return {
            ...
            onUnhandledError (error) {
                ...
                const componentStack = (0, _stitchederror.getComponentStack)(error);
                const ownerStack = (0, _stitchederror.getOwnerStack)(error);
                dispatch({
                    type: _shared.ACTION_UNHANDLED_ERROR,
                    reason: error,
                    frames: (0, _parsestack.parseStack)((error.stack || '') + (ownerStack || '')),
                    componentStackFrames: typeof componentStack === 'string' ? (0, _parsecomponentstack.parseComponentStack)(componentStack) : undefined
                });
            },
    ...
    (0, _useerrorhandler.useErrorHandler)(dispatcher.onUnhandledError, dispatcher.onUnhandledRejection);
