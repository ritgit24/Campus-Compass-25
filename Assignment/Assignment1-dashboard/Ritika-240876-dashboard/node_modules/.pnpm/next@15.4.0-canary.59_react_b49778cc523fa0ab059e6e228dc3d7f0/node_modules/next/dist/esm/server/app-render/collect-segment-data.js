...
export async function collectSegmentData(fullPageDataBuffer, staleTime, clientModules, serverConsumerManifest, fallbackRouteParams) {
...
async function PrefetchTreeData({ fullPageDataBuffer, fallbackRouteParams, serverConsumerManifest, clientModules, staleTime, segmentTasks, onCompletedProcessingRouteTree }) {
    ...
    // each segment.
    const tree = collectSegmentDataImpl(flightRouterState, buildId, seedData, fallbackRouteParams, clientModules, ROOT_SEGMENT_KEY, segmentTasks);
...
function collectSegmentDataImpl(route, buildId, seedData, fallbackRouteParams, clientModules, key, segmentTasks) {
    ...
    if (seedData !== null) {
        ...
        waitAtLeastOneReactRenderTask().then(()=>renderSegmentPrefetch(buildId, seedData, key, clientModules)));
    } else {
