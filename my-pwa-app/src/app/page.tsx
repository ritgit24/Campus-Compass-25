...
//     {/* Custom Profile Heading with Optimized Image */}
//     <div className="text-center sm:text-left w-full">
//       <div className="flex flex-col sm:flex-row items-center gap-6 mb-8">
//         {/* Optimized Image */}
//         <div className="relative w-24 h-24 sm:w-32 sm:h-32 rounded-full overflow-hidden border-4 border-white dark:border-gray-800 shadow-lg">
//           <Image
//             src="/person2.jpg" // Ensure this is in your public folder
...
//         <div>
//           <h1 className="text-4xl sm:text-5xl font-bold bg-gradient-to-r from-blue-600 to-purple-500 bg-clip-text text-transparent mb-2">
//             Sabrina
//           </h1>
...
//       <div className="h-px w-full bg-gradient-to-r from-transparent via-gray-300 to-transparent dark:via-gray-600 my-6" />
//     </div>
//     <h1 className="text-4xl sm:text-5xl font-bold bg-gradient-to-r from-blue-600 to-purple-500 bg-clip-text text-transparent mb-2">
//             Exploration
//           </h1>
...
//             Reviews given : 
//           </h2>
//           <Carousel className="w-full max-w-md"> {/* Increased max-width */}
//   <CarouselContent>
//     {[
//       {
//         image: "mamamio.jpg", // Paths to your images
//         title: "Mama Mio",
//         description: "Good food but a poor seating arrangement"
//       },
//       {
//         image: "oat.jpg",
//         title: "OAT, NewSAC", 
//         description: "Humangous in size , an epitome of freedom . I love the vibe there!"
//       },
//       {
//         image: "ccd.jpg",
//         title: "CCD",
...
//         <div className="p-1">
//           <Card>
//             <CardContent className="flex flex-col items-center p-4 gap-4"> {/* Changed to column layout */}
//               {/* Image Section */}
...
//                   {item.description}
//                 </p>
//                 <button className="mt-2 px-4 py-2 bg-blue-500 text-white rounded-md text-sm hover:bg-blue-600 transition">
//                   View Location
//                 </button>
//               </div>
//             </CardContent>
...
//       <CardHeader>
//         <CardTitle>OAT</CardTitle>
//         <CardDescription>
//          You starred this place. Wanna visit again?
//         </CardDescription>
//         <CardAction>
...
//           ) : (
//             <StarEmpty className="w-5 h-5 text-gray-300" />
//           )}
//         </span>
//       ))}
